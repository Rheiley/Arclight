...
# image = Image.open(requests.get('https://cdn.icon-icons.com/icons2/3249/PNG/512/flashlight_filled_icon_200605.png', stream=True).raw)
...
# icon = pystray.Icon("Arclight", image, menu = pystray.Menu(
